...
const Numbers = () => {
  ...
  let numRanges = [
    { gurmukhi: '੦ - ੧੦', arabic: '(0 - 10)' }, 
    { gurmukhi: '੧੧ - ੨੦', arabic: '(11 - 20)' },
    { gurmukhi: '੨੧ - ੩੦', arabic: '(21 - 30)' }, 
    { gurmukhi: '੩੧ - ੪੦', arabic: '(31 - 40)' }, 
    { gurmukhi: '੪੧ - ੫੦', arabic: '(41 - 50)' }, 
    { gurmukhi: '੫੧ - ੬੦', arabic: '(51 - 60)' }, 
    { gurmukhi: '੬੧ - ੭੦', arabic: '(61 - 70)' }, 
    { gurmukhi: '੭੧ - ੮੦', arabic: '(71 - 80)' }, 
    { gurmukhi: '੮੧ - ੯੦', arabic: '(81 - 90)' }, 
    { gurmukhi: '੯੧ - ੧੦੦', arabic: '(91 - 100)' }, 
    { gurmukhi: '੧੦੧ +', arabic: '(101 +)' }
  ]
  ...
  return (
    ...
    <>
      ...
      <View style={{ flexDirection: 'row', backgroundColor: "#009DC2", paddingTop: 30 }}>
        ...
        <Text style={{ fontSize: 30, marginTop: headerMarginTop, marginLeft: 110, color: '#1D2359', textAlign: 'center' }}>Numbers</Text>
